...
movie_session_list = MovieSessionViewSet.as_view(actions={"get": "list", "post": "create"})
...
urlpatterns = [
    ...
    path("api/cinema/genres/", genre_list, name="genre_list"),
    path("api/cinema/genres/<int:pk>/", genre_hall_detail, name="genre_detail"),
    path("api/cinema/movies/", movie_list, name="movie_list"),
    path("api/cinema/movies/<int:pk>/", movie_detail, name="movie_detail"),
    path("api/cinema/cinema_halls/", cinema_hall_list, name="cinema_hall_list"),
    path(
        "api/cinema/cinema_halls/<int:pk>/",
        cinema_hall_detail,
        name="cinema_hall_detail"
    ),
    path("api/cinema/actors/", actor_list, name="actor_list"),
    path("api/cinema/actors/<int:pk>/", actor_detail, name="actor_detail"),
    path("api/cinema/movie_sessions/", movie_session_list, name="movie_session_list"),
    path("api/cinema/movie_sessions/<int:pk>/", movie_session_detail, name="movie_session_detail"),
]
